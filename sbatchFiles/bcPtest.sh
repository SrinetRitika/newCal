...
# Run the R script
srun singularity_wrapper exec Rscript --no-save bcPtest.R
# Correct permissions
chmod -Rf a+rwx /scratch/project_2000994/calibrations/srinet/newCal/chains/chains_01 || true
