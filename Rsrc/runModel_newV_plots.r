...
### variable plots
allVar_master <- data.table(V=as.vector(modOut1$output[,,30,,1]), B=as.vector(modOut1$output[,,13,,1]),
                     H=as.vector(modOut1$output[,,11,,1]), D=as.vector(modOut1$output[,,12,,1]),
                     cal_set='set 1', speciesID=as.vector(speciesNam[modOut1$output[,,4,,1]]))
allVar_master <- rbind(allVar_master, data.table(V=as.vector(modOut2$output[,,30,,1]), B=as.vector(modOut2$output[,,13,,1]),
                                                 H=as.vector(modOut2$output[,,11,,1]), D=as.vector(modOut2$output[,,12,,1]),
                                                 cal_set='set 2', speciesID=as.vector(speciesNam[modOut2$output[,,4,,1]])))
allVar_master <- rbind(allVar_master, data.table(V=as.vector(modOut3$output[,,30,,1]), B=as.vector(modOut3$output[,,13,,1]),
                                                 H=as.vector(modOut3$output[,,11,,1]), D=as.vector(modOut3$output[,,12,,1]),
                                                 cal_set='set 3', speciesID=as.vector(speciesNam[modOut3$output[,,4,,1]])))
allVar_master <- rbind(allVar_master, data.table(V=as.vector(modOut4$output[,,30,,1]), B=as.vector(modOut4$output[,,13,,1]),
                                                 H=as.vector(modOut4$output[,,11,,1]), D=as.vector(modOut4$output[,,12,,1]),
                                                 cal_set='set 4', speciesID=as.vector(speciesNam[modOut4$output[,,4,,1]])))
allVar_master <- rbind(allVar_master, data.table(V=as.vector(modOut5$output[,,30,,1]), B=as.vector(modOut5$output[,,13,,1]),
                                                 H=as.vector(modOut5$output[,,11,,1]), D=as.vector(modOut5$output[,,12,,1]),
                                                 cal_set='set 5', speciesID=as.vector(speciesNam[modOut5$output[,,4,,1]])))


allVar_newP <- data.table(V=as.vector(modOut1_newPar$output[,,30,,1]), B=as.vector(modOut1_newPar$output[,,13,,1]),
                            H=as.vector(modOut1_newPar$output[,,11,,1]), D=as.vector(modOut1_newPar$output[,,12,,1]),
                            cal_set='set 2', speciesID=as.vector(speciesNam[modOut1_newPar$output[,,4,,1]]))
allVar_newP <- rbind(allVar_newP, data.table(V=as.vector(modOut2_newPar$output[,,30,,1]), B=as.vector(modOut2_newPar$output[,,13,,1]),
                                                 H=as.vector(modOut2_newPar$output[,,11,,1]), D=as.vector(modOut2_newPar$output[,,12,,1]),
                                                 cal_set='set 2', speciesID=as.vector(speciesNam[modOut2_newPar$output[,,4,,1]])))
allVar_newP <- rbind(allVar_newP, data.table(V=as.vector(modOut3_newPar$output[,,30,,1]), B=as.vector(modOut3_newPar$output[,,13,,1]),
                                                 H=as.vector(modOut3_newPar$output[,,11,,1]), D=as.vector(modOut3_newPar$output[,,12,,1]),
                                                 cal_set='set 3', speciesID=as.vector(speciesNam[modOut3_newPar$output[,,4,,1]])))
allVar_newP <- rbind(allVar_newP, data.table(V=as.vector(modOut4_newPar$output[,,30,,1]), B=as.vector(modOut4_newPar$output[,,13,,1]),
                                                 H=as.vector(modOut4_newPar$output[,,11,,1]), D=as.vector(modOut4_newPar$output[,,12,,1]),
                                                 cal_set='set 4', speciesID=as.vector(speciesNam[modOut4_newPar$output[,,4,,1]])))
allVar_newP <- rbind(allVar_newP, data.table(V=as.vector(modOut5_newPar$output[,,30,,1]), B=as.vector(modOut5_newPar$output[,,13,,1]),
                                                 H=as.vector(modOut5_newPar$output[,,11,,1]), D=as.vector(modOut5_newPar$output[,,12,,1]),
                                                 cal_set='set 5', speciesID=as.vector(speciesNam[modOut5_newPar$output[,,4,,1]])))

allVar_newV <- data.table(V=as.vector(modOut1_newV$output[,,30,,1]), B=as.vector(modOut1_newV$output[,,13,,1]),
                          H=as.vector(modOut1_newV$output[,,11,,1]), D=as.vector(modOut1_newV$output[,,12,,1]),
                          cal_set='set 1', speciesID=as.vector(speciesNam[modOut1_newV$output[,,4,,1]]))
allVar_newV <- rbind(allVar_newV, data.table(V=as.vector(modOut2_newV$output[,,30,,1]), B=as.vector(modOut2_newV$output[,,13,,1]),
                                             H=as.vector(modOut2_newV$output[,,11,,1]), D=as.vector(modOut2_newV$output[,,12,,1]),
                                             cal_set='set 2', speciesID=as.vector(speciesNam[modOut2_newV$output[,,4,,1]])))
allVar_newV <- rbind(allVar_newV, data.table(V=as.vector(modOut3_newV$output[,,30,,1]), B=as.vector(modOut3_newV$output[,,13,,1]),
                                             H=as.vector(modOut3_newV$output[,,11,,1]), D=as.vector(modOut3_newV$output[,,12,,1]),
                                             cal_set='set 3', speciesID=as.vector(speciesNam[modOut3_newV$output[,,4,,1]])))
allVar_newV <- rbind(allVar_newV, data.table(V=as.vector(modOut4_newV$output[,,30,,1]), B=as.vector(modOut4_newV$output[,,13,,1]),
                                             H=as.vector(modOut4_newV$output[,,11,,1]), D=as.vector(modOut4_newV$output[,,12,,1]),
                                             cal_set='set 4', speciesID=as.vector(speciesNam[modOut4_newV$output[,,4,,1]])))
allVar_newV <- rbind(allVar_newV, data.table(V=as.vector(modOut5_newV$output[,,30,,1]), B=as.vector(modOut5_newV$output[,,13,,1]),
                                             H=as.vector(modOut5_newV$output[,,11,,1]), D=as.vector(modOut5_newV$output[,,12,,1]),
                                             cal_set='set 5', speciesID=as.vector(speciesNam[modOut5_newV$output[,,4,,1]])))

allVar_newVP <- data.table(V=as.vector(modOut1_newV_Par$output[,,30,,1]), B=as.vector(modOut1_newV_Par$output[,,13,,1]),
                          H=as.vector(modOut1_newV_Par$output[,,11,,1]), D=as.vector(modOut1_newV_Par$output[,,12,,1]),
                          cal_set='set 1', speciesID=as.vector(speciesNam[modOut1_newV_Par$output[,,4,,1]]))
allVar_newVP <- rbind(allVar_newVP, data.table(V=as.vector(modOut2_newV_Par$output[,,30,,1]), B=as.vector(modOut2_newV_Par$output[,,13,,1]),
                                             H=as.vector(modOut2_newV_Par$output[,,11,,1]), D=as.vector(modOut2_newV_Par$output[,,12,,1]),
                                             cal_set='set 2', speciesID=as.vector(speciesNam[modOut2_newV_Par$output[,,4,,1]])))
allVar_newVP <- rbind(allVar_newVP, data.table(V=as.vector(modOut3_newV_Par$output[,,30,,1]), B=as.vector(modOut3_newV_Par$output[,,13,,1]),
                                             H=as.vector(modOut3_newV_Par$output[,,11,,1]), D=as.vector(modOut3_newV_Par$output[,,12,,1]),
                                             cal_set='set 3', speciesID=as.vector(speciesNam[modOut3_newV_Par$output[,,4,,1]])))
allVar_newVP <- rbind(allVar_newVP, data.table(V=as.vector(modOut4_newV_Par$output[,,30,,1]), B=as.vector(modOut4_newV_Par$output[,,13,,1]),
                                             H=as.vector(modOut4_newV_Par$output[,,11,,1]), D=as.vector(modOut4_newV_Par$output[,,12,,1]),
                                             cal_set='set 4', speciesID=as.vector(speciesNam[modOut4_newV_Par$output[,,4,,1]])))
allVar_newVP <- rbind(allVar_newVP, data.table(V=as.vector(modOut5_newV_Par$output[,,30,,1]), B=as.vector(modOut5_newV_Par$output[,,13,,1]),
                                            H=as.vector(modOut5_newV_Par$output[,,11,,1]), D=as.vector(modOut5_newV_Par$output[,,12,,1]),
                                            cal_set='set 5', speciesID=as.vector(speciesNam[modOut5_newV_Par$output[,,4,,1]])))

pdf(file="out/output_variable_compare1.pdf")

dh_m1<-ggplot(allVar_master[cal_set=='set 1'],aes(x=D,y=H,col=speciesID)) +
  geom_point() + ggtitle("D vs. H - current version\nactual pValues\n") +
  theme(plot.title = element_text(size=10)) + xlim(0,80) + ylim(0,50)
dh_m2<-ggplot(allVar_master[cal_set=='set 2'],aes(x=D,y=H,col=speciesID)) +
  geom_point() + ggtitle("D vs. H - current version\nactual pValues\n") +
  theme(plot.title = element_text(size=10)) + xlim(0,80) + ylim(0,50)
dh_m3<-ggplot(allVar_master[cal_set=='set 3'],aes(x=D,y=H,col=speciesID)) +
  geom_point() + ggtitle("D vs. H - current version\nactual pValues\n") +
  theme(plot.title = element_text(size=10)) + xlim(0,80) + ylim(0,50)
dh_m4<-ggplot(allVar_master[cal_set=='set 4'],aes(x=D,y=H,col=speciesID)) +
  geom_point() + ggtitle("D vs. H - current version\nactual pValues\n") +
  theme(plot.title = element_text(size=10)) + xlim(0,80) + ylim(0,50)
dh_m5<-ggplot(allVar_master[cal_set=='set 5'],aes(x=D,y=H,col=speciesID)) +
  geom_point() + ggtitle("D vs. H - current version\nactual pValues\n") +
  theme(plot.title = element_text(size=10)) + xlim(0,80) + ylim(0,50)
ggarrange(dh_m1,dh_m2,dh_m3,dh_m4,dh_m5, ncol = 3, nrow = 2, legend = "right", common.legend = F)

dh_m<-ggplot(allVar_master,aes(x=D,y=H,col=speciesID)) +
  geom_point() + ggtitle("D vs. H - current version\nactual pValues\n") +
  theme(plot.title = element_text(size=10)) + xlim(0,80) + ylim(0,50)
dh_newp<-ggplot(allVar_newP,aes(x=D,y=H,col=speciesID)) +
  geom_point() + ggtitle("D vs. H - current version\nsuggested pValues\n")+
  theme(plot.title = element_text(size=10)) + xlim(0,80) + ylim(0,50) 
dh_newv<-ggplot(allVar_newV,aes(x=D,y=H,col=speciesID)) +
  geom_point() + ggtitle("D vs. H - new version\nactual pValues\n")+
  theme(plot.title = element_text(size=10)) + xlim(0,80) + ylim(0,50) 
dh_newVP<-ggplot(allVar_newVP,aes(x=D,y=H,col=speciesID)) +
  geom_point() + ggtitle("D vs. H - new version\nsuggested pValues\n")+
  theme(plot.title = element_text(size=10)) + xlim(0,80) + ylim(0,50)

db_m<-ggplot(allVar_master,aes(x=D,y=B,col=speciesID)) +
  geom_point() + ggtitle("D vs. B - current version\nactual pValues\n") +
  theme(plot.title = element_text(size=10)) + xlim(0,80) + ylim(0,70)
db_newp<-ggplot(allVar_newP,aes(x=D,y=B,col=speciesID)) +
  geom_point() + ggtitle("D vs. B - current version\nsuggested pValues\n")+
  theme(plot.title = element_text(size=10)) + xlim(0,80) + ylim(0,70) 
db_newv<-ggplot(allVar_newV,aes(x=D,y=B,col=speciesID)) +
  geom_point() + ggtitle("D vs. B - new version\nactual pValues\n")+
  theme(plot.title = element_text(size=10)) + xlim(0,80) + ylim(0,70) 
db_newVP<-ggplot(allVar_newVP,aes(x=D,y=B,col=speciesID)) +
  geom_point() + ggtitle("D vs. B - new version\nsuggested pValues\n")+
  theme(plot.title = element_text(size=10)) + xlim(0,80) + ylim(0,70)

dv_m<-ggplot(allVar_master,aes(x=D,y=V,col=speciesID)) +
  geom_point() + ggtitle("D vs. V - current version\nactual pValues\n") +
  theme(plot.title = element_text(size=10)) + xlim(0,80) + ylim(0,800)
dv_newp<-ggplot(allVar_newP,aes(x=D,y=V,col=speciesID)) +
  geom_point() + ggtitle("D vs. V - current version\nsuggested pValues\n")+
  theme(plot.title = element_text(size=10)) + xlim(0,80) + ylim(0,800) 
dv_newv<-ggplot(allVar_newV,aes(x=D,y=V,col=speciesID)) +
  geom_point() + ggtitle("D vs. V - new version\nactual pValues\n")+
  theme(plot.title = element_text(size=10)) + xlim(0,80) + ylim(0,800) 
dv_newVP<-ggplot(allVar_newVP,aes(x=D,y=V,col=speciesID)) +
  geom_point() + ggtitle("D vs. V - new version\nsuggested pValues\n")+
  theme(plot.title = element_text(size=10)) + xlim(0,80) + ylim(0,800)

hb_m<-ggplot(allVar_master,aes(x=H,y=B,col=speciesID)) +
  geom_point() + ggtitle("H vs. B - current version\nactual pValues\n") +
  theme(plot.title = element_text(size=10)) + xlim(0,50) + ylim(0,70)
hb_newp<-ggplot(allVar_newP,aes(x=H,y=B,col=speciesID)) +
  geom_point() + ggtitle("H vs. B - current version\nsuggested pValues\n")+
  theme(plot.title = element_text(size=10)) + xlim(0,50) + ylim(0,70) 
hb_newv<-ggplot(allVar_newV,aes(x=H,y=B,col=speciesID)) +
  geom_point() + ggtitle("H vs. B - new version\nactual pValues\n")+
  theme(plot.title = element_text(size=10)) + xlim(0,50) + ylim(0,70) 
hb_newVP<-ggplot(allVar_newVP,aes(x=H,y=B,col=speciesID)) +
  geom_point() + ggtitle("H vs. B - new version\nsuggested pValues\n")+
  theme(plot.title = element_text(size=10)) + xlim(0,50) + ylim(0,70)

hv_m<-ggplot(allVar_master,aes(x=H,y=V,col=speciesID)) +
  geom_point() + ggtitle("H vs. V - current version\nactual pValues\n") +
  theme(plot.title = element_text(size=10)) + xlim(0,50) + ylim(0,800)
hv_newp<-ggplot(allVar_newP,aes(x=H,y=V,col=speciesID)) +
  geom_point() + ggtitle("H vs. V - current version\nsuggested pValues\n")+
  theme(plot.title = element_text(size=10)) + xlim(0,50) + ylim(0,800) 
hv_newv<-ggplot(allVar_newV,aes(x=H,y=V,col=speciesID)) +
  geom_point() + ggtitle("H vs. V - new version\nactual pValues\n")+
  theme(plot.title = element_text(size=10)) + xlim(0,50) + ylim(0,800) 
hv_newVP<-ggplot(allVar_newVP,aes(x=H,y=V,col=speciesID)) +
  geom_point() + ggtitle("H vs. V - new version\nsuggested pValues\n")+
  theme(plot.title = element_text(size=10)) + xlim(0,50) + ylim(0,800)

bv_m<-ggplot(allVar_master,aes(x=B,y=V,col=speciesID)) +
  geom_point() + ggtitle("B vs. V - current version\nactual pValues\n") +
  theme(plot.title = element_text(size=10)) + xlim(0,70) + ylim(0,800)
bv_newp<-ggplot(allVar_newP,aes(x=B,y=V,col=speciesID)) +
  geom_point() + ggtitle("B vs. V - current version\nsuggested pValues\n")+
  theme(plot.title = element_text(size=10)) + xlim(0,70) + ylim(0,800) 
bv_newv<-ggplot(allVar_newV,aes(x=B,y=V,col=speciesID)) +
  geom_point() + ggtitle("B vs. V - new version\nactual pValues\n")+
  theme(plot.title = element_text(size=10)) + xlim(0,70) + ylim(0,800) 
bv_newVP<-ggplot(allVar_newVP,aes(x=B,y=V,col=speciesID)) +
  geom_point() + ggtitle("B vs. V - new version\nsuggested pValues\n")+
  theme(plot.title = element_text(size=10)) + xlim(0,70) + ylim(0,800)

ggarrange(dh_m,dh_newp,dh_newv,dh_newVP, ncol = 2, nrow = 2, legend = "right", common.legend = T)
ggarrange(db_m,db_newp,db_newv,db_newVP, ncol = 2, nrow = 2, legend = "right", common.legend = T)
ggarrange(dv_m,dv_newp,dv_newv,dv_newVP, ncol = 2, nrow = 2, legend = "right", common.legend = T)
ggarrange(hb_m,hb_newp,hb_newv,hb_newVP, ncol = 2, nrow = 2, legend = "right", common.legend = T)
ggarrange(hv_m,hv_newp,hv_newv,hv_newVP, ncol = 2, nrow = 2, legend = "right", common.legend = T)
ggarrange(bv_m,bv_newp,bv_newv,bv_newVP, ncol = 2, nrow = 2, legend = "right", common.legend = T)
dev.off()
