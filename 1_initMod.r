...
load("C:/Users/checcomi/Documents/research/calibrations/pine/initPrebas.rdata")
pine <- initPrebas
pine_B <- outdata_B
pine_D <- outdata_D
pine_H <- outdata_H
...
load("C:/Users/checcomi/Documents/research/calibrations/spruce/initPrebas.rdata")
spruce <- initPrebas
spruce_B <- outdata_B
spruce_D <- outdata_D
spruce_H <- outdata_H
...
load("C:/Users/checcomi/Documents/research/calibrations/nfi/initPrebas.rdata")
nfi <- initPrebas
nfi_B <- outdata_B
nfi_D <- outdata_D
nfi_H <- outdata_H
...
load("C:/Users/checcomi/Documents/github/newCal/inputs/initPrebas_old growth.rdata")
old <- initPrebas
